...
execute unless score $align_distance_x __variable__ matches 0 run execute if score $tick_modulo __variable__ matches 0 run function conveys:__private__/if_else/1